...
class EmpleadoAdapter(var lista: MutableList<Empleado>, private val deleteEmpleado: (Empleado) -> Unit, private val updateEmpleado: (Empleado) -> Unit, private val infoEmpleado: (Empleado) -> Unit):
